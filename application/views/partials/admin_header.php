			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?php echo base_url();?>assetadmin/img/user.png" class="img-circle" alt="Avatar"> <span><?php echo $u->firstname?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
